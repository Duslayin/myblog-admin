<template>
  <div>
        ...
        <el-col :span="4">
          <el-form-item label="昵称"
            ...
            <el-input placeholder="请输入昵称"
                      ...
                      clearable
                      @keydown.enter.native="loadDataList">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="4">
    ...
    <!--新增成员弹窗-->
    <Dialog :dialogVisible="editDialogInfo.show"
        ...
        <el-row>
          ...
          <el-col :span="14">
            <div style="width: 85%;">
              ...
              <template v-if="formData.userId == null">
    ...
    <!--修改密码-->
    <Dialog :dialogVisible="dialogConfig.show"
...
const tableData = ref({})
const formData = ref({ editorType: 1 })
